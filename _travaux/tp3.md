...
Vous pouvez la télécharger ici : [Téléchargement de la machine virtuelle](https://cmaisonneuveqcca-my.sharepoint.com/:u:/r/personal/ophenix_cmaisonneuve_qc_ca/Documents/Cours/420-950-MA%20-%20Cybers%C3%A9curit%C3%A9/Mat%C3%A9riel%20de%20cours/420-950-MA-TP3.ova?csf=1&web=1&e=BU38JF)
...
1. Importez la machine virtuelle fournie (.ova) dans **VirtualBox ou VMware** (téléchargez [ici](https://cmaisonneuveqcca-my.sharepoint.com/:u:/r/personal/ophenix_cmaisonneuve_qc_ca/Documents/Cours/420-950-MA%20-%20Cybers%C3%A9curit%C3%A9/Mat%C3%A9riel%20de%20cours/420-950-MA-TP3.ova?csf=1&web=1&e=BU38JF))
...
{: .warning}
> Votre code s'exécute derrière un *reverse proxy* nginx. Il est possible que votre code perçoive la requête entrante en provenance de **127.0.0.1**. Il existe certains en-têtes HTTP qui sont ajoutés par les *reverse proxy* afin de contourner ce problème...
