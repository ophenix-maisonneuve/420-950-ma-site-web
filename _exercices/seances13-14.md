...
- Vérifiez que vous arrivez à communiquer avec GhostBeacon en pointant votre navigateur vers :
   ...
   - *Vous devriez voir `Impossible de lire le fichier [...]`*
...
1. Dans la nouvelle fenêtre, cliquez à nouveau sur **Add**
1. Dans la nouvelle fenêtre...
   - Ajoutez une charge utile (*payload*) de type **Regex**
      - Cette fois, créez vous-même une expression régulière spécifiquement pour cette route. On peut par exemple penser à exploiter le *Path Traversal* ou un possible *Cross-site Scripting*...
