...
# A09 - Logging & Alerting Failures (Journaux et alertes défaillants)
...
Les entrées utilisateur ne sont pas **encodées avant d’être journalisées** ; un attaquant injecte des séquences qui **faussent** l’analyse (ex. spoof d’identité, leurre des SOC playbooks).  
