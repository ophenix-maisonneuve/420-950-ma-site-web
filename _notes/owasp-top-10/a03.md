...
Un framework réputé s’appuie sur une **dépendance transitive non maintenue**. Sans **inventaire** ni **scan régulier**, l’organisation **ignore** le risque et **retarde** les mises à jour ; une vulnérabilité connue est exploitée en production.  
