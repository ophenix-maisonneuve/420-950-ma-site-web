...
5. **Cas particuliers**  
   Pour le **XSS**, appliquer un **encodage contextuel** rigoureux et des patrons de rendu sûrs ; pour la **commande OS**, utiliser des **APIs natives** (exec paramétré, pas de shell) ; surveiller les **templates ou langages d'expression** (*expression languages*). 
