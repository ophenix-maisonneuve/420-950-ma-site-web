...
Les contributeurs de données pour l’édition 2025 ont constaté que **100 % des applications testées** contenaient au moins une forme de bris du contrôle d’accès, ce qui en fait la vulnérabilité la plus répandue et la plus critique. Cette catégorie regroupe **40 CWE**, incluant notamment les failles liées au SSRF, désormais intégrées à A01. 
