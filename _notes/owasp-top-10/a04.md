...
1. **Chiffrer systématiquement en transit**  
   Forcer TLS à jour (versions/protocoles/cipher suites sûrs), **vérifier la chaîne de confiance** et les attributs du certificat (nom d’hôte, validité). Interdire les *fallback* an clair et bloquer les downgrades explicites.
